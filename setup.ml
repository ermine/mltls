...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5e770268474e1866c9246545e01650bb) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description = Some "Bindings to OpenSSL library.";
          categories = [];
            ...
            [
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources = ["mltls_stub.c"; "wrapper.h"];
                      bs_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "state_machine.ml"; });
               Doc
                 ({
                     cs_name = "api";
                     cs_data = PropList.Data.create ();
               ...
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "git://github.com/ermine/mltls.git";
                      src_repo_browser =
                        Some "https://github.com/ermine/mltls";
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "Ilπ¨ö…EÉ\b±ãπ\0259O_";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
