(*
 * (c) 206-2008 Anastasia Gornostaeva <ermine@ermine.pp.ru>
 *)
...
external tls_ERR_get_error : unit -> int32 = "camltls_ERR_get_error"
...
external tls_SSL_CTX_new : tls_method -> tls_SSL_CTX = "camltls_SSL_CTX_new"
type certificate_file_type = SSL_FILETYPE_PEM | SSL_FILETYPE_ASN1
external tls_SSL_CTX_use_certificate_file :
  tls_SSL_CTX -> string -> certificate_file_type -> int
  = "camltls_SSL_CTX_use_certificate_file"
external tls_SSL_CTX_use_PrivateKey_file :
  tls_SSL_CTX -> string -> certificate_file_type -> int
  = "camltls_SSL_CTX_use_PrivateKey_file"
external tls_SSL_new : tls_SSL_CTX -> tls_SSL = "camltls_SSL_new"
...
external tls_SSL_set_wfd : tls_SSL -> Unix.file_descr -> int
  = "camltls_SSL_set_wfd"
external tls_BIO_new : unit -> tls_BIO = "camltls_BIO_new"
...
external tls_SSL_accept : tls_SSL -> int = "camltls_SSL_accept"
external tls_SSL_connect : tls_SSL -> int = "camltls_SSL_connect"
external tls_SSL_do_handshake : tls_SSL -> int = "camltls_SSL_do_handshake"
type ssl_error =
    SSL_ERROR_NONE
  | SSL_ERROR_SSL
  | SSL_ERROR_WANT_READ
...
val string_of_ssl_error : ssl_error -> string
external tls_SSL_get_error : tls_SSL -> int -> ssl_error
  = "camltls_SSL_get_error"
external tls_SSL_library_init : unit -> unit = "camltls_SSL_library_init"
...
external tls_SSL_write : tls_SSL -> string -> int -> int -> int
  = "camltls_SSL_write"
external tls_BIO_pending : tls_BIO -> int = "camltls_BIO_pending"
external tls_BIO_read : tls_BIO -> string -> int -> int = "camltls_BIO_read"
external tls_BIO_gets : tls_BIO -> string -> int -> int = "camltls_BIO_gets"
external tls_BIO_write : tls_BIO -> string -> int -> int
  = "camltls_BIO_write"
external tls_BIO_puts : tls_BIO -> string -> int = "camltls_BIO_puts"
...
external tls_SSL_CTX_set_verify :
  tls_SSL_CTX -> set_verify_mode list -> verify_callback -> unit
