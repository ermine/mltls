(* OASIS_START *)
(* DO NOT EDIT (digest: df84aaa66a2d7295e3fae78bcfc2284f) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("mltls", [])];
     lib_c = [("mltls", ".", ["wrapper.h"])];
     flags =
       [
          (["oasis_library_mltls_cclib"; "link"],
            [(OASISExpr.EBool true, S [A "-cclib"; A "-lssl"])]);
          (["oasis_library_mltls_cclib"; "ocamlmklib"; "c"],
